...
import { Activity, Eye, EyeOff, Mail, Lock, User, ArrowRight, Stethoscope, Shield, Heart, Users } from "lucide-react";
...
const roles: { value: AppRole; label: string; description: string; icon: React.ElementType }[] = [
  ...
  { value: "doctor", label: "Doctor", description: "Clinical management", icon: Stethoscope },
  { value: "nurse", label: "Nurse", description: "Patient care", icon: Heart },
  { value: "patient", label: "Patient", description: "Personal health portal", icon: Users },
];
        ...
        <div className="relative z-10 space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-white/80 text-lg max-w-md">
              Create your account and get instant access to our comprehensive hospital management platform.
            </p>
          </div>
